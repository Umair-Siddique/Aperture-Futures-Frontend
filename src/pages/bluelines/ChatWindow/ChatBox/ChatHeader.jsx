      ...
      <div className="relative" ref={dropdownRef}>
        <button
          ...
          style={{
            ...
            ":hover": { backgroundColor: "#0074A2" },
          }}
          onMouseEnter={(e) => (e.target.style.backgroundColor = "#0074A2")}
            ...
            <div className="p-2">
              ...
              {availableModels?.map((model) => (
                <button
                  ...
                  style={{
                    backgroundColor:
                      currentModel?.id === model.id ? "#5BC0EB" : "transparent",
                    color: currentModel?.id === model.id ? "white" : "#E0E0E0",
                  }}
                  onMouseEnter={(e) => {
